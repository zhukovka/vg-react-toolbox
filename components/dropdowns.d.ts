...
export interface DropdownPlusProps extends __ReactToolbox.Props {
    /**
     ...
     */
    onAddAnother?: __React.FocusEventHandler;
    /**
     * Callback function that is fired when the component is blurred.
     */
...
export class DropdownPlus extends __React.Component<DropdownPlusProps, {}> { }
