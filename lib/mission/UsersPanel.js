...
var UsersPanel = function UsersPanel(_ref) {
  ...
  return _react2.default.createElement(
    ...
    { title: 'Users', active: open, pinned: open, onClick: onClick, buttons: [addUserBtn], className: 'usersPanel' },
    _react2.default.createElement(
      'div',
      { style: _extends({ overflow: 'auto' }, style), className: 'vg-styled-scrollbar' },
      children
    )
  );
};
