...
var OrgAdminsForm = function (_VGComponentForm) {
    ...
    function OrgAdminsForm(props) {
        ...
        var _this$props$info = _this.props.info,
            firstname = _this$props$info.firstname,
            lastname = _this$props$info.lastname,
            email = _this$props$info.email,
            phone = _this$props$info.phone,
            title = _this$props$info.title,
            notes = _this$props$info.notes;
    ...
    _createClass(OrgAdminsForm, [{
        ...
        value: function renderFormContent() {
            var _props$info = this.props.info,
                firstname = _props$info.firstname,
                lastname = _props$info.lastname,
                email = _props$info.email,
                phone = _props$info.phone,
                title = _props$info.title,
                notes = _props$info.notes;
