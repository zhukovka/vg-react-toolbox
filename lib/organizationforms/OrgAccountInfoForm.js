...
var _AccountInfo = require('.././AccountInfo.ts');

var _AccountInfo2 = _interopRequireDefault(_AccountInfo);

var _FormActionsBack = require('.././FormActionsBack.ts');
...
var OrgAccountInfoForm = function (_VGComponentForm) {
    ...
    function OrgAccountInfoForm(props) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OrgAccountInfoForm).call(this, props));
