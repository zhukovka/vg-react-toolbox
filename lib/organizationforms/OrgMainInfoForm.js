...
var OrgMainInfoForm = function (_VGComponentForm) {
    ...
    function OrgMainInfoForm(props) {
        ...
        var _info$address = info.address,
            street = _info$address.street,
            city = _info$address.city,
            state = _info$address.state,
            postcode = _info$address.postcode,
            country = _info$address.country;
    ...
    _createClass(OrgMainInfoForm, [{
        ...
        value: function renderFormContent() {
            var paragraphStyle = { textAlign: 'center' };
            var _props = this.props,
                info = _props.info,
                orgActions = _props.orgActions;
            var _info$address2 = info.address,
                street = _info$address2.street,
                city = _info$address2.city,
                state = _info$address2.state,
                postcode = _info$address2.postcode,
                country = _info$address2.country;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_uploadZone.Upload, { onUpload: this.props.onCompanyLogoUpload })
                    ),
                    _react2.default.createElement(
                        _grid.Col,
                        { small: 12, medium: 6, large: 6 },
                        ...
                        _react2.default.createElement(_uploadZone.Upload, { onUpload: this.props.onPlayerOverlayUpload })
                    )
                ),
                _react2.default.createElement(
                    _grid.Row,
...
OrgMainInfoForm.propTypes = {
    ...
    onCompanyLogoUpload: _react.PropTypes.func,
    onPlayerOverlayUpload: _react.PropTypes.func,
