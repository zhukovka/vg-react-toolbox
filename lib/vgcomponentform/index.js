    ...
    _createClass(VGComponentForm, [{
        ...
        value: function renderDropDowns() {
            ...
            return dropdowns.map(function (dropdown) {
                ...
                var _onChange = dropdown.onChange;
                var value = dropdown.value;

                var other = _objectWithoutProperties(dropdown, ['key', 'onChange', 'value']);
        ...
        value: function renderInput(_input) {
            ...
            var key = _input.key;
            var _onChange2 = _input.onChange;
            var value = _input.value;

            var other = _objectWithoutProperties(_input, ['key', 'onChange', 'value']);
