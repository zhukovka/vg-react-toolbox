...
var _HardWare = require('../classes/HardWare');
...
var HardWareForm = function (_VGComponentForm) {
    ...
    function HardWareForm(props) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HardWareForm).call(this, props));
...
HardWareForm.propTypes = {
    info: _react.PropTypes.instanceOf(_HardWare2.default),
