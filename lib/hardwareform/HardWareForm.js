...
var HardWareForm = function (_VGComponentForm) {
    ...
    function HardWareForm(props) {
        ...
        var _this$props$info = _this.props.info,
            type = _this$props$info.type,
            manufacturer = _this$props$info.manufacturer,
            model = _this$props$info.model,
            uid = _this$props$info.uid,
            port = _this$props$info.port;

        _this.state = _this.setInitialState([type, manufacturer, model, uid, port]);
        return _this;
    }
    /**
    ...
    _createClass(HardWareForm, [{
        ...
        value: function renderFormContent() {
            var _props$info = this.props.info,
                ...
                manufacturer = _props$info.manufacturer,
                model = _props$info.model,
                uid = _props$info.uid,
                port = _props$info.port;
            var _props$hardwareAction = this.props.hardwareActions,
                cancel = _props$hardwareAction.cancel,
                finish = _props$hardwareAction.finish;
